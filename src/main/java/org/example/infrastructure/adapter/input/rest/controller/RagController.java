...
public class RagController {
    ...
    public RagController(OpenAiChatClient aiClient, VectorStore vectorStore) {
        this.aiClient = aiClient;
        this.vectorStore = vectorStore;
    }

    @GetMapping("/ai/rag")
    public ResponseEntity<String> generateAnswer(@RequestParam(value = "query", defaultValue = "Tell me a joke") String query) {
